...
export const FETCH_INGREDIENTS_PARAMS = 'FETCH_INGREDIENTS_PARAMS';
export const SAVE_INGREDIENTS_PARAMS = 'SAVE_INGREDIENTS_PARAMS';
export const ADD_INGREDIENT = 'ADD_INGREDIENT';
export const REMOVE_INGREDIENT = 'REMOVE_INGREDIENT';
export const CHANGE_INGREDIENT = 'CHANGE_INGREDIENT';
export const SAVE_INGREDIENTS = 'SAVE_INGREDIENTS';
export const FETCH_INGREDIENTS_DATA_FAILED = 'FETCH_INGREDIENTS_DATA_FAILED';
